...
We are committed to providing a welcoming and inclusive environment for all contributors and users. We expect all participants to treat each other with respect and professionalism.
...
Maintainers will review reports and take appropriate action, which may include warnings, temporary bans, or permanent removal from the project.
